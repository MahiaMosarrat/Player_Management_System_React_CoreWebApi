...
namespace PlayerManagement.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EvaluationCategory>().HasData(
                new EvaluationCategory { EvaluationCategoryId = 1, CategoryName = "Batting" },
                new EvaluationCategory { EvaluationCategoryId = 2, CategoryName = "Bowling" },
                new EvaluationCategory { EvaluationCategoryId = 3, CategoryName = "Fielding" }
            );
            modelBuilder.Entity<EvaluationType>().HasData(
                new EvaluationType { EvaluationTypeId = 1, TypeName = "Admission" },
                new EvaluationType { EvaluationTypeId = 2, TypeName = "Training" },
                new EvaluationType { EvaluationTypeId = 3, TypeName = "Match" }
            );
